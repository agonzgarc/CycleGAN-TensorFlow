...
from modelPairedDEx import PairedGANDisen
  ...
  with tf.Session(graph=graph) as sess:
    ...
    try:
      ...
      while not coord.should_stop():
        ...
        #train
        _, G_loss_val, D_Y_loss_val, Dex_Y_loss_val, F_loss_val, D_X_loss_val, Dex_X_loss_val, A_loss_val, Feat_loss_val, DC_loss_val, summary = (
              sess.run(
                  [optimizers, G_loss, D_Y_loss, Dex_Y_loss, F_loss, D_X_loss,
                   Dex_X_loss, A_loss, Feat_loss, DC_loss, summary_op],

...
from modelDisen import CycleGANDisen
...
tf.flags.DEFINE_string('X', 'data/tfrecords/domain_MNIST.tfrecords',
                       'X tfrecords file for training')
tf.flags.DEFINE_string('Y', 'data/tfrecords/domain_MNISTC.tfrecords',
                       'Y tfrecords file for training')
tf.flags.DEFINE_string('load_model', None,
                        'folder of saved model that you wish to continue training (e.g. 20170602-1936), default: None')
nameNet = 'mnistc_disen'

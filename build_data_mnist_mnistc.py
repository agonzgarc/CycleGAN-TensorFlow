...
tf.flags.DEFINE_string('data0_output_file', 'data/tfrecords/domain_MNIST.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/orange.tfrecords')

tf.flags.DEFINE_string('data1_output_file', 'data/tfrecords/domain_MNISTC.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/orange.tfrecords')
...
def main(unused_argv):
  print("Convert data0 to tfrecords...")
  data_writer(FLAGS.data0_input_dir, FLAGS.data0_output_file)

  print("Convert  data1 to tfrecords...")
  data_writer(FLAGS.data1_input_dir, FLAGS.data1_output_file)

  ...
  def __call__(self, input):
    ...
    with tf.variable_scope(self.name):
        ...
        #with g.gradient_override_map({"Identity": "ReverseGrad"}):
            ...
            fc_output = ops.fully_connected(idinput, reuse=self.reuse, name ='fc1',units=100)
            fc_output = ops.fully_connected(idinput, reuse=self.reuse, name ='fc2',units=100)

            output = ops.logits(fc_output, reuse=self.reuse, name ='logits',units=10)
